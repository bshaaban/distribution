...
type InitFunc func(ctx context.Context, registry distribution.Namespace, driver driver.StorageDriver, options map[string]interface{}) (distribution.Namespace, error)
...
func Get(ctx context.Context, name string, options map[string]interface{}, registry distribution.Namespace, driver driver.StorageDriver) (distribution.Namespace, error) {
	if middlewares != nil {
